...
import { font, radius, themes } from '@/constants/theme';
...
function SubjectRevisionGroup({ chapters, index }: { chapters: ChapterStat[]; index: number }) {
  const { theme } = useAppTheme();
  ...
  return <Animated.View style={[styles.group, { backgroundColor: theme.surface, borderColor: theme.line, opacity: entrance, transform: [{ translateY }] }]}>
