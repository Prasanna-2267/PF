...
export default function AccountScreen() {
  ...
  return <SafeAreaView style={[styles.safe, { backgroundColor: theme.canvas }]} edges={['left', 'right']}><ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    ...
    <Card><Text style={[styles.cardTitle, { color: theme.fg }]}>Admin demo</Text><Text style={[styles.copy, { color: theme.muted }]}>Review the operational workspace with local UI data.</Text><AppButton label="Open admin workspace" variant="secondary" onPress={() => router.push('/admin/login')} /></Card>
